...
function HeroSection() {
  ...
  return (
    <div className="flex flex-wrap gap-5 p-4 md:p-0 justify-center w-screen">
      <HeroHighlight>
        <motion.h1
          initial={{
            opacity: 0,
      ...
      >
        ...
        <CardContent className="flex flex-col gap-3">
          ...
          >
            ...
            <span className="italic font-serif font-normal">exceptional </span>{" "}
            digital experiences.
          </motion.p>
        </CardContent>
        <CardFooter>
          ...
          >
            Hey!, I’m Ikhsan! Welcome to my world. I specialize in designing and
            developing beautiful, user-friendly websites and digital
